...
public class AirportTest {
    ...
    private final MilitaryPlane transportMilitaryPlane = new MilitaryPlane("C-130 Hercules", 650, 5000, 110000, MilitaryType.TRANSPORT);
    private final PassengerPlane planeWithMaxPassengerCapacity = new PassengerPlane("Boeing-747", 980, 16100, 70500, 242);
    private final List<MilitaryPlane> bomberMilitaryPlanes = Arrays.asList(
            new MilitaryPlane("B-1B Lancer", 1050, 21000, 80000, MilitaryType.BOMBER),
            new MilitaryPlane("B-2 Spirit", 1030, 22000, 70000, MilitaryType.BOMBER),
            new MilitaryPlane("B-52 Stratofortress", 1000, 20000, 80000, MilitaryType.BOMBER)
    );
    ...
    private boolean isClassificationLevelHigherThanUnclassified(List<ExperimentalPlane> experimentalPlanes) {
        return experimentalPlanes.stream()
                ...
                .allMatch(classificationLevel -> classificationLevel.ordinal() > ClassificationLevel.UNCLASSIFIED.ordinal());
    }
